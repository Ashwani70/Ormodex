...
export const metadata = {
  title: "About Us",
  description: "Ormodex ERP helps Indian manufacturers, traders and exporters run their entire operation on one GST-compliant, AI-powered platform.",
};
      ...
      <section className="mx-auto max-w-3xl px-5 py-16">
        <Reveal>
          <p className="text-lg leading-relaxed text-body">
            Ormodex ERP was built for businesses that make and move real things —
