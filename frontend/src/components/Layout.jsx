...
function useGlobalSearch() {
  ...
  const QUICK_LINKS = [
    ...
    { label: "Day Book", path: "/accounting?tab=daybook", icon: "📒" },
    { label: "Cash Flow", path: "/accounting?tab=cashflow", icon: "💵" },
    { label: "Interest Outstanding", path: "/accounting?tab=interest", icon: "⚖️" },
